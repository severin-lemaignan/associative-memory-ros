...
#include "AssociativeMemory/memory_network.hpp"
...
class MemoryView : public SDLApp {
    ...
    ros::NodeHandle nh;
    ros::Rate rate;
    ros::Subscriber attention_targets;

    void on_attention_target(const playground_builder::AttentionTargetsStamped::ConstPtr& msg);
